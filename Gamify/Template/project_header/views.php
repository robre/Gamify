<ul class="views">
   ...
   <?php endif ?>
     ...
     <li <?= $this->app->checkMenuSelection('GamificationController') ?>>
	<i class="fa fa-diamond fa-fw"></i>
        <?= $this->url->link(t('Gamify'), 'GamificationController', 'show', array('plugin' => 'Gamify', 'project_id' => $project['id'], 'search' => $filters['search']), false, 'view-board', t('Keyboard shortcut: "%s"', 'none')) ?>
    </li>
