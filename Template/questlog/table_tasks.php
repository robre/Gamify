...
<tr class="board-swimlane board-swimlane-tasks-<?= $swimlane['id'] ?>">
    <?php foreach ($swimlane['columns'] as $column): ?>
        <td class="
            ...
            "
        >
	    <div class="questlog-column-bg" style="display: none;text-align: center;">
		<?= $this->text->e($column['title']) ?>
            ...
            <div
                ...
                <?php foreach ($column['tasks'] as $task): ?>
                    <?= $this->render($not_editable ? 'questlog:questlog/task_public' : 'questlog:questlog/task_private', array(
                        'project' => $project,
                        'task' => $task,
